import { mxClient, mxCodec, mxClipboard, mxGraphModel, mxUtils, mxGraph, mxEvent } from "mxgraph-js";

function Clipboard(graph)
{
    ...
    mxEvent.addListener(document, 'keyup', function(evt)
    {
        ...
        // Deletes selected element on backspace keyup
    mxEvent.addListener(document, 'keyup', function(evt){
        if (evt.keyCode == '8' ) 
            {
        ...
        // Select All on A keyup
        mxEvent.addListener(document, 'keyup', function(evt){
            if (evt.keyCode == '65' ) 
                {
                    let selectedCell = graph.getDefaultParent();
                    
                    graph.selectAll(selectedCell);                       
    ...
    //UNDO
    mxEvent.addListener(textInput, 'z', mxUtils.bind(this, function(evt)
    {
        console.log('zzz');
    }));
